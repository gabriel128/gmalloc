...
#define log_debug(M, ...) fprintf(stderr, ANSI_COLOR_CYAN "[DEBUG] (%s:%d) " M ANSI_COLOR_RESET "\n",  \
...
#define log_info(M, ...) fprintf(stderr, ANSI_COLOR_GREEN "[INFO] (%s:%d) " M ANSI_COLOR_RESET "\n",  \
                                 __FILE__, __LINE__, ##__VA_ARGS__)
